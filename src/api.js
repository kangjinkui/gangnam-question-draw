...
export function revertDrawnQuestion(operatorPin, id) { return callApi('revertDraw', { operatorPin, id }); }
...
export function deleteQuestions(operatorPin, ids) { return callApi('deleteQuestions', { operatorPin, ids }); }
